...
class OrderPreRequirementsWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var appTxt = AppLocalizations.of(context)!;
    return Container(
      ...
      child: Column(
        children: [
          Text(
            AppLocalizations.of(context)!.createDocumentTitle,
      ...
      children: [
        Expanded(
          child: RequiredInfoDesign(
              label: AppLocalizations.of(context)!.currencyTxt,
        ...
        Row(
          children: [
            Text(
              AppLocalizations.of(context)!.sendToETSTxt,
              style: Theme.of(context)
                  .textTheme
                  .titleMedium!
